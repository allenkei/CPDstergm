...
RcppExport SEXP _CPDstergm_cal_log_likelihood(SEXP H_pos_listSEXP, SEXP H_neg_listSEXP, SEXP y_pos_listSEXP, SEXP y_neg_listSEXP, SEXP theta_matSEXP, SEXP tauSEXP, SEXP p1SEXP, SEXP p2SEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(cal_log_likelihood(H_pos_list, H_neg_list, y_pos_list, y_neg_list, theta_mat, tau, p1, p2));
    return rcpp_result_gen;
END_RCPP
}
// CPD_STERGM_cpp
List CPD_STERGM_cpp(int ADMM_iter, int theta_iter, int z_iter, List H_pos_list, List H_neg_list, List y_pos_list, List y_neg_list, arma::mat theta_mat, arma::mat z_mat, arma::mat u_mat, arma::mat X_mat, arma::vec d_vec, double alpha, int tau, int p1, int p2, double lambda, double theta_tol, double ADMM_tol, bool update_alpha, bool verbose);
RcppExport SEXP _CPDstergm_CPD_STERGM_cpp(SEXP ADMM_iterSEXP, SEXP theta_iterSEXP, SEXP z_iterSEXP, SEXP H_pos_listSEXP, SEXP H_neg_listSEXP, SEXP y_pos_listSEXP, SEXP y_neg_listSEXP, SEXP theta_matSEXP, SEXP z_matSEXP, SEXP u_matSEXP, SEXP X_matSEXP, SEXP d_vecSEXP, SEXP alphaSEXP, SEXP tauSEXP, SEXP p1SEXP, SEXP p2SEXP, SEXP lambdaSEXP, SEXP theta_tolSEXP, SEXP ADMM_tolSEXP, SEXP update_alphaSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(CPD_STERGM_cpp(ADMM_iter, theta_iter, z_iter, H_pos_list, H_neg_list, y_pos_list, y_neg_list, theta_mat, z_mat, u_mat, X_mat, d_vec, alpha, tau, p1, p2, lambda, theta_tol, ADMM_tol, update_alpha, verbose));
    return rcpp_result_gen;
END_RCPP
}
// cal_M_for_cov
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_CPDstergm_CPD_STERGM_cpp", (DL_FUNC) &_CPDstergm_CPD_STERGM_cpp, 21},
