...
cal_M_for_cov <- function(H_pos_list, H_neg_list, y_pos_list, y_neg_list, theta_mat, tau, p1, p2) {
    .Call(`_CPDstergm_cal_M_for_cov`, H_pos_list, H_neg_list, y_pos_list, y_neg_list, theta_mat, tau, p1, p2)
}

cal_B_for_cov <- function(H_pos_list, H_neg_list, y_pos_list, y_neg_list, theta_mat, tau, p1, p2) {
    .Call(`_CPDstergm_cal_B_for_cov`, H_pos_list, H_neg_list, y_pos_list, y_neg_list, theta_mat, tau, p1, p2)
}
